...
public class ReelPostActivity extends AppCompatActivity {
    ...
    private androidx.appcompat.widget.AppCompatButton btnPost;
    ...
    private androidx.appcompat.widget.SwitchCompat switchShareToFeed;
    ...
    private void setupHashtagInput() {
        ...
        // Keyboard "Done" pe bhi add ho jaye agar kuch typed hai
    ...
    private void setupSuggestionRecycler() {
        // Suggestion tap → chip seedha add, koi button nahi
    ...
    private void addChip(String tag) {
        if (selectedHashtags.contains(tag)) return; // duplicate nahi
    ...
    private void postReel() {
        ...
        MultipartBody.Part videoPart =
                MultipartBody.Part.createFormData("Video", videoFile.getName(), videoBody);
        ...
        UtilMethods.INSTANCE.saveReel(
                loader,
                caption,
                durationSeconds,  // auto from MediaModel
                hashtags,
                videoPart,
                finalThumbPart,
                new UtilMethods.ApiCallBackMulti() {
                    ...
                    public void onSuccess(Object response) {
                        runOnUiThread(() -> {
                            ...
                            Toast.makeText(ReelPostActivity.this,
                                    "Reel shared!", Toast.LENGTH_SHORT).show();
